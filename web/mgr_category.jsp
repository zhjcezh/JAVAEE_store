...
<script>
    $(function () {
        ...
        $("#addcategory").click(function () {
            ...
            alert(cname);
            /*发送请求*/
            $(window).attr('location','${pageContext.request.contextPath}/category_add.action?cname='+cname);
        });
        ...
        $("#updatebtn").click(function () {
            ...
            var cid2 = $("#cid2").val();
            /*2.发送请求*/
            $(window).attr('location','${pageContext.request.contextPath}/category_update.action?cname='+cname2+'&cid='+cid2);
