...
<div class="main_top">
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">商品管理
...
<div class="goods_list">
    ...
    <s:iterator value="list" var="book">
        <ul class="list_goods_ul">
            <li><s:property value="#book.book_id"/> </li>
            <li><s:property value="#book.book_title"/></li>
            <li><s:property value="#book.category.cname"/></li>
            <li>
                <a href="${ctx}/book_edit.action?book_id=<s:property value="#book.book_id"/>">
                    <img class="img_icon" src="${ctx }/images/edit_icon.png" alt="">
                </a>
            </li>
            <li>
                <a href="${ctx }/book_delete.action?book_id=<s:property value='#book.book_id'/>">
...
<script>
    ...
    $("#input_search_btn").click(function () {
        ...
        /*alert(keyWord);*/
        //发送请求
        $(window).attr('location','/book_pageList.action?keyWord='+keyWord);
    });
