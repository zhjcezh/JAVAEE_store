...
<ul>
    <li><a href="${pageContext.request.contextPath}/category_list.action" target="mainFrame"><i></i>
        分类管理</a></li>
    <li><a href="${pageContext.request.contextPath}/book_pageList.action" target="mainFrame"><i></i>商品管理</a></li>
    <li><a href="${pageContext.request.contextPath}/user_list.action" target="mainFrame"><i></i>用户管理</a></li>
</ul>
